...
"""
    gen_polgraph(m::POMDP{S,A}, s_pomdp::EvalTabularPOMDP, pol::Policy, b0::DiscreteBelief, depth::Int; return_beliefs::Bool=false)
    gen_polgraph(m::POMDP{S,A}, pol::Policy, b0::DiscreteBelief, depth::Int; store_beliefs::Bool=false)
