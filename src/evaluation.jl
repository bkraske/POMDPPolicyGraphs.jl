...
"""
    gen_eval_polgraph(m::POMDP, pol::AlphaVectorPolicy, b0::DiscreteBelief, depth::Int; eval_tolerance::Float64=0.001, rewardfunction=VecReward(), use_beliefs::Bool=true, returnpg=false)
...
function gen_eval_polgraph(m::POMDP{S,A},pol::AlphaVectorPolicy,b0::DiscreteBelief, depth::Int; 
    ...
    s_m = EvalTabularPOMDP(m;rew_f=rewardfunction,r_len=rew_size)
    pg = gen_polgraph(m, s_m, pol, b0, depth; store_beliefs=use_beliefs)
...
#     eval_tolerance::Float64=0.001, rewardfunction=VecReward(), disc=discount(m), use_beliefs::Bool=true)
#     @warn "Updater argument has been removed. Update call"
#     return gen_eval_polgraph(m::POMDP{S,A},pol::AlphaVectorPolicy,b0::DiscreteBelief, depth::Int; 
#     eval_tolerance=eval_tolerance, rewardfunction=rewardfunction, disc=disc, use_beliefs::Bool=use_beliefs)
# end
...
"""
    belief_value_polgraph(m::POMDP, pol::AlphaVectorPolicy, b0::DiscreteBelief, depth::Int; eval_tolerance::Float64=0.001, rewardfunction=VecReward(), beliefbased=true)
...
function belief_value_polgraph(m::POMDP{S,A}, pol::AlphaVectorPolicy, 
    ...
    values,pg = gen_eval_polgraph(m, pol, b0, depth;
